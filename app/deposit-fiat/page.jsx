            ...
            <div className="mt-9 ">
              ...
              {/* <div className='flex items-center gap-5 mt-5 lg:hidden'>
                        <div className="w-[500px] mx-auto lg:p-2 bg-[#F8F8F8] rounded-lg border border-[#B2B2B27A] responsive-widths">
                            ...
                            <div className='lg:flex items-center justify-center hidden'>
                              <button className={`py-2 w-[90%] mx-auto text-white bg-primary-color rounded-[6px] mb-3 mt-[4rem] ${redHatMono.className}`} onClick={() => router.replace(`/deposit-provider`)} >Proceed</button>
                            </div>
                        </div>
                    </div> */}
