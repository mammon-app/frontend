        ...
        <div className="flex flex-col justify-center items-center relative z-[11]">
          <div className="border border-[#B2B2B27A] px-4 sm:px-8 pt-8 pb-5 rounded-[16px]  w-full sm:w-[588px]">
            ...
            <div className="text-center mb-12 mt-[-80px] relative z-[100]">
              ...
              <p className="text-[#ffffff] sm:text-[14px] text-[14px]">Dive back into a world of premium features and explore the endless possibilities that await. Reconnect and continue your journey today.</p>
            </div>
            
            <form className="flex flex-col sm:w-[400px] mx-auto">

              <div className="w-full flex flex-col gap-3 mb-[20px]">
                <button onClick={handleGoogleLogin} className="bg-transparent border border-[#B2B2B27A] text-[#ffffff] py-2 px-4 rounded-[8px] sm:text-[16px] text-[14px] flex items-center justify-center w-full shadow">
                  ...
                  <div>
                    {
                      ...
                      <ImCheckboxUnchecked className='cursor-pointer text-white' onClick={() => setPasswordType('text')}/>
                      :
                      <ImCheckboxChecked className='cursor-pointer text-white' onClick={() => setPasswordType('password')}/>
                    }
                  </div>
                </div>
              </div>
